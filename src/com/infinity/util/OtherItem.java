...
public class OtherItem {
    ...
    public OtherItem(String fileName, String colorBlockNumber, String inertiaTensorNumber, String fuelLineToggle) {
        ...
        try { // 当文件不存在时报错
            read = reader.read(props.getProperty("user.home") + "/Library/Application Support/com.jundroo.SimpleRockets2/UserData/CraftDesigns/" + fileName + ".xml");
        ...
        try {
            FileOutputStream fos = new FileOutputStream(props.getProperty("user.home") + "/Library/Application Support/com.jundroo.SimpleRockets2/UserData/CraftDesigns/" + fileName + "-Edit.xml");
