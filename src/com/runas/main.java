...
public class main {
    ...
    public static void main(String[] args) {
        ...
        changeFunction.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        changeFile.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        officialWebsite.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        authorProfile.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        studioFansChat.setFont(new Font("微软雅黑", Font.PLAIN, 14));
        ...
        collisionModel.setPreferredSize(new Dimension(140, 30));
        ...
        airDragToggleLabel.setPreferredSize(new Dimension(125, 30));
